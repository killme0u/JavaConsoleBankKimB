...
public class ValidateInput {
	...
	static AccountType fetchAccountType(String accountTypeNo) {
		return validateAccountType(accountTypeNo) == SUCCESS
			? AccountType.from(accountTypeNo) : null;
	}
	...
	static void showErrorMessage(CustomException ce) {
		System.out.println();
		System.err.printf("%s\n", ce.getMessage());
		System.out.println();
	}
